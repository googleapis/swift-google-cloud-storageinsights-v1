...
public struct ListReportDetailsRequest: Codable, Equatable, GoogleCloudWkt._AnyPackable,
  Sendable
{
  ...
  /// Initialize a new instance of `ListReportDetailsRequest`.
  public init() {}
  ...
  ///
  /// ```
  /// let value = ListReportDetailsRequest().with { $0.parent = ... }
  /// ```
