...
///
/// [google.cloud.storageinsights.v1.StorageInsights.ListDatasetConfigs]: <doc:StorageInsightsClient/listDatasetConfigs(request:options:)>
public struct ListDatasetConfigsResponse: Codable, Equatable, GoogleWKT._AnyPackable,
  GoogleGax._PaginatedResponse,
  Sendable
{
  /// The list of `DatasetConfigs`
  public var datasetConfigs: [DatasetConfig] = []
  ...
  /// Initialize a new instance of `ListDatasetConfigsResponse`.
  public init() {}
  ...
  ///
  /// ```
  /// let value = ListDatasetConfigsResponse().with { $0.datasetConfigs = ... }
  /// ```
  ...
  private struct CodingKeys: CodingKey {
    ...
    static let datasetConfigs = CodingKeys(stringValue: "datasetConfigs")
  ...
  public init(from decoder: Decoder) throws {
    ...
    if let value = try container.decodeIfPresent([DatasetConfig].self, forKey: .datasetConfigs) {
      self.datasetConfigs = value
    }
  ...
  public func encode(to encoder: Encoder) throws {
    ...
    try container.encode(self.datasetConfigs, forKey: .datasetConfigs)
  ...
  public func _getPaginatedItems() -> [DatasetConfig] {
    return self.datasetConfigs
  }
