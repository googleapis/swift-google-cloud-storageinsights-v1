  ...
  Sendable
{
  ...
  public var type: Identity.IdentityType = Identity.IdentityType()
  ...
  public init(from decoder: Decoder) throws {
    ...
    if let value = try container.decodeIfPresent(Identity.IdentityType.self, forKey: .type) {
      self.type = value
    }
  ...
  public enum IdentityType: Codable, Equatable, Sendable {
    ...
    public var intValue: Int? {
      ...
      case .perConfig: return 1
      case .perProject: return 2
    ...
    public var stringValue: Swift.String? {
      ...
      case .perConfig: return "IDENTITY_TYPE_PER_CONFIG"
      case .perProject: return "IDENTITY_TYPE_PER_PROJECT"
    ...
    public init(stringValue: Swift.String) {
      ...
      case "IDENTITY_TYPE_PER_CONFIG": self = .perConfig
      case "IDENTITY_TYPE_PER_PROJECT": self = .perProject
    ...
    public init(intValue: Int) {
      ...
      case 1: self = .perConfig
      case 2: self = .perProject
  ...
  public static var _anyTypeUrl: Swift.String {
    return "type.googleapis.com/google.cloud.storageinsights.v1.Identity"
  }
