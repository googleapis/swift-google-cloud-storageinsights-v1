...
public struct ListReportDetailsResponse: Codable, Equatable, GoogleCloudWKT._AnyPackable,
  ...
  Sendable
{
  ...
  /// Initialize a new instance of `ListReportDetailsResponse`.
  public init() {}
  ...
  ///
  /// ```
  /// let value = ListReportDetailsResponse().with { $0.reportDetails = ... }
  /// ```
  ...
  private struct CodingKeys: CodingKey {
    ...
    static let reportDetails = CodingKeys(stringValue: "reportDetails")
  ...
  public init(from decoder: Decoder) throws {
    ...
    if let value = try container.decodeIfPresent([ReportDetail].self, forKey: .reportDetails) {
  ...
  public func encode(to encoder: Encoder) throws {
    ...
    try container.encode(self.reportDetails, forKey: .reportDetails)
  ...
  public static var _anyTypeUrl: Swift.String {
    return "type.googleapis.com/google.cloud.storageinsights.v1.ListReportDetailsResponse"
  }
  ...
  public func _getPaginatedItems() -> [ReportDetail] {
